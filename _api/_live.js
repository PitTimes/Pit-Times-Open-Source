...
const EventTitleLive = `<div class="col-md-25 col-lg-50 d-flex align-items-stretch mb-5 mb-lg-3"> <div class="icon-box35" data-aos="fade-up" data-aos-delay="100"> <h4 class="box1"><a>Live Race Highlights</a></h4> <h4 class="title"><a href="https://pittimes.netlify.app/live">${Title}</a></h4> </div> </div>`
